(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["pagesA-content_detail-content_detail"],
  {
    ...
    "933a": function (t, e, i) {
      ...
      n("73aa8971", a, !0, { sourceMap: !1, shadowMode: !1 });
    },
    "96a7": function (t, e, i) {
      "use strict";
      i.d(e, "b", function () {
        ...
        n = function () {
          ...
          return i(
            ...
            [
              ...
              i(
                "v-uni-view",
                { staticClass: "page-container", style: t.containerstyle },
                [
                  i(
                    "v-uni-view",
                    { staticClass: "top-container" },
                    [
                      i("v-uni-view", { staticClass: "detail-title-view" }, [
                        t._v(t._s(t.detailinfo.title)),
                      ]),
                      i(
                        "v-uni-view",
                        { staticClass: "detail-desc-view" },
                        [
                          i("v-uni-view", { staticClass: "label-type" }, [
                            t._v(t._s(t.detailinfo.label[0])),
                          ]),
                          i("v-uni-view", { staticClass: "detail-time" }, [
                            t._v(t._s(t.detailinfo.created_time)),
                          ]),
                        ],
                        1
                      ),
                  ...
                  i(
                    "v-uni-view",
                    { staticClass: "html-container" },
                    [
                      i("mp-html", {
                        attrs: { content: t.htmlStr, selectable: !0 },
                      }),
                    ],
                    1
                  ),
                  i(
                    "v-uni-view",
                    { staticClass: "action-bottom-view" },
                    [
                      i(
                        "v-uni-view",
                        {
                          class: [
                            "action-item",
                            { "action-item-active": t.IsAppreciated },
                          ],
                          staticStyle: { "margin-right": "100upx" },
                          on: {
                            click: function (e) {
                              (arguments[0] = e = t.$handleEvent(e)),
                                t.AppreciatedContent();
                            },
                          },
                        },
                        [
                      ...
                      i(
                        "v-uni-view",
                        {
                          class: [
                            "action-item",
                            { "action-item-active": t.IsCollected },
                          ],
                          on: {
                            click: function (e) {
                              (arguments[0] = e = t.$handleEvent(e)),
                  ...
                  i(
                    ...
                    [
                      i("v-uni-view", { staticClass: "container-view-title" }, [
                        t._v("系列相关"),
                      ]),
                      i(
                        "v-uni-view",
                        {
                          staticClass:
                            "botoom-recommend-container-view recommend-container-view",
                        },
                        t._l(t.RecommendList, function (e) {
                          return i(
                            ...
                            [
                              i(
                                "v-uni-view",
                                { staticClass: "recommend-item-face" },
                                [
                                  i("v-uni-image", {
                                    attrs: {
                                      mode: "scaleToFill",
                              ...
                              i(
                                "v-uni-view",
                                { staticClass: "recommend-item-title" },
                                [t._v(t._s(e.title))]
                              ),
                            ],
                            1
    ...
    e190: function (t, e, i) {
      ...
      (function (t) {
        ...
        var n = a(i("f07e")),
          o = a(i("c964"));
        i("c975"), i("d3b7"), i("99af"), i("159b"), i("14d9"), i("e9c4");
        var c = a(i("6972")),
          s = {
            components: {},
            data: function () {
            ...
            computed: {
              ...
              IsCollected: function () {
                var t = !1;
                return (
                  c.default.isNullOrEmpty(this.project.CollectionedContentId) ||
                    -1 ==
                      this.project.CollectionedContentId.indexOf(
                        this.detailinfo.id
                      ) ||
                    (t = !0),
                  t
            ...
            onLoad: function (t) {
              (this.StartReadTime = new Date().getTime()),
                (this.detailinfo = JSON.parse(decodeURIComponent(t.Content))),
                this.RequestHtmlDataStr(this.detailinfo.detail_url),
                this.QuerySameLabelContentList();
            },
            onUnload: function () {
              var t = new Date().getTime() - this.StartReadTime;
              this.FlagReadContent(c.default.MillisecondToDate(t / 1e3));
            },
            methods: {
                      ...
                      while (1)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.next = 2),
                              c.default.CalcDomHeight(".top-container", t)
                            );
                          case 2:
                            return (
                              (i = e.sent),
                              (e.next = 5),
                              c.default.CalcDomHeight(".action-bottom-view", t)
                            );
                          case 5:
                            return (
                              (a = e.sent),
                              (e.next = 8),
                              c.default.CalcDomHeight(".bottom-container", t)
                            );
                          case 8:
                            (o = e.sent),
                              (t.WebViewContentHeight =
                                t.Systeminfo.screenHeight -
                                t.CustomBar -
                                i -
                                a -
                                o -
                                uni.upx2px(76)),
                              t.InitContentWebview();
                          case 11:
                          case "end":
                            return e.stop();
                        }
              ...
              FlagReadContent: function (e) {
                c.default
                  .sendapppost(
                    this.project.server_addr +
                      c.default.API_PATH.DiscoverContentClick,
                    {
                      id: this.detailinfo.id,
                      userinfo: {
                        staff_name: this.userdata.detailinfo.name,
                        staff_phone: this.userdata.detailinfo.phone,
                        staff_sex: this.userdata.detailinfo.sex,
                        staff_project: this.project.projectname,
                      },
                      readinfo: { read_time: e },
                    }
                  )
                  .then(function (t) {})
                  .catch(function (e) {
              ...
              QuerySameLabelContentList: function () {
                var e = this;
                c.default
                  .sendapppost(
                    this.project.server_addr +
                      c.default.API_PATH.ListDiscoverContent,
                    {
                      page_index: 1,
                      page_size: 3,
                      category: this.detailinfo.category,
                      except_id: this.detailinfo.id,
                    }
                  )
                  .then(function (t) {
              ...
              RecommendItemClick: function (t) {
                var e = new Date().getTime() - this.StartReadTime;
                this.FlagReadContent(c.default.MillisecondToDate(e / 1e3)),
                  (this.StartReadTime = new Date().getTime()),
                  (this.detailinfo = t),
                  this.RequestHtmlDataStr(this.detailinfo.detail_url),
              ...
              RequestHtmlDataStr: function (e) {
                var i = this;
                t.log(e),
                  (this.IsAppreciated = uni.getStorageSync(
                    "discover_content_appreciate_" + this.detailinfo.id
                  )),
                  uni.request({
                    url: ""
                      .concat(e, "?timespan=")
              ...
              AppreciatedContent: function () {
                var t = !0;
                this.IsAppreciated && (t = !1),
                  uni.setStorageSync(
                    "discover_content_appreciate_" + this.detailinfo.id,
                    t
                  ),
                  (this.IsAppreciated = t);
              },
              CollectContent: function () {
                ...
                c.default
                  .sendapppost(
                    this.project.server_addr +
                      c.default.API_PATH.SaveStaffCollectDiscovercontent,
                    { content_id: this.detailinfo.id }
                  )
                  .then(function (e) {
                    var i = [];
                    ...
                    var a = JSON.parse(JSON.stringify(t.$store.state.project));
                    (a.CollectionedContentId = i),
                      (t.project = a),
                      t.$store.commit("SetProjectData", a);
                  })
                  .catch(function (t) {})
                  .finally(function () {});
              },
