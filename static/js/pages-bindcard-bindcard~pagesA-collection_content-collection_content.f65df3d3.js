(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["pages-bindcard-bindcard~pagesA-collection_content-collection_content"],
  {
        ...
        var o = e(n("fad2")),
          a = {
            ...
            methods: {
              ...
              open: function (i) {
                this.showPopup &&
                  (clearTimeout(this.timer), (this.showPopup = !1));
                (i &&
                  -1 !==
                    [
                      "top",
            ...
            methods: {
              init: function () {
                ...
                t.duration && (this.durationTime = t.duration),
                  (this.animation = (0, r.createAnimation)(
              ...
              step: function (i) {
                ...
                if (this.animation) {
                  for (var e in i)
                    try {
                      var s;
                      if ("object" === (0, a.default)(i[e]))
                        (s = this.animation)[e].apply(s, (0, o.default)(i[e]));
                      else this.animation[e](i[e]);
                    } catch (r) {
                      t.error("方法 ".concat(e, " 不存在"));
                    }
                ...
                "undefined" !== typeof n && (this.opacity = n),
                  ...
                  this.$nextTick(function () {
                    t.timer = setTimeout(function () {
                      (t.animation = (0, r.createAnimation)(t.config, t)),
              ...
              styleInit: function (t) {
                var i = this,
                  ...
                  e = function (t, e) {
                    "fade" === e
                      ? (n.opacity = i.animationType(t)[e])
                      : (n.transform += i.animationType(t)[e] + " ");
                  };
                return (
                ...
                var i = this,
                  n = function (t, n) {
                    ...
                    "fade" === n
                      ...
                      : ((e = t ? "-100%" : "0"),
                        "zoom-in" === n && (e = t ? 0.8 : 1),
                        "zoom-out" === n && (e = t ? 1.2 : 1),
                        "slide-right" === n && (e = t ? "100%" : "0"),
                        "slide-bottom" === n && (e = t ? "100%" : "0")),
                      i.animation[i.animationMode()[n]](e);
                  };
                return (
                  "string" === typeof this.modeClass
                    ? n(t, this.modeClass)
    ...
    "73b6": function (t, i, n) {
      ...
      o("6bf8a73c", e, !0, { sourceMap: !1, shadowMode: !1 });
    },
    "9c80": function (t, i, n) {
      "use strict";
      n.r(i);
            ...
            (0, s.default)(t, [
              {
                ...
                value: function (t, i) {
                  var n = this.currentStepAnimates[this.next],
                    e = {};
                  if (((e = n || { styles: {}, config: {} }), u.includes(t))) {
    ...
    f89b: function (t, i, n) {
      ...
      var o = e(n("173a")),
        a = e(n("632d")),
        s = e(n("30dd")),
        r = { en: o.default, "zh-Hans": a.default, "zh-Hant": s.default };
      i.default = r;
    },
    fad2: function (t, i, n) {
      "use strict";
    ...
    fff6: function (t, i, n) {
      ...
      var e = { uniTransition: n("db9b").default },
        o = function () {
          var t = this,
            i = t.$createElement,
            n = t._self._c || i;
