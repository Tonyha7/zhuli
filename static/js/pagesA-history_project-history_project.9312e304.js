  ...
  ["pagesA-history_project-history_project"],
  {
    ...
    "52f5": function (t, e, n) {
      ...
      (e = i(!1)),
        e.push([
          t.i,
          ".cu-bar .search-form[data-v-07a6a5da]{background-color:#fff;border:1px solid #d6dae6}.action-icon[data-v-07a6a5da]{color:#d6dae6}.project-item-container[data-v-07a6a5da]{margin:%?40?%;border-bottom:1px dashed #d6dae6;position:relative;padding-right:%?40?%}.project-item-container>.name[data-v-07a6a5da]{margin:%?20?% 0;font-size:%?35?%;font-family:PingFang SC;font-weight:500;color:#333}.project-item-container>.content[data-v-07a6a5da]{display:flex;align-items:center;justify-content:space-between;padding-bottom:%?20?%;min-height:%?60?%}.project-item-container>.content>.desc-item[data-v-07a6a5da]{color:#9096a8;flex:1}.action-area[data-v-07a6a5da]{position:absolute;display:inline-block;top:25%;right:0}.action-area>uni-image[data-v-07a6a5da]{height:%?40?%;width:%?40?%}",
          "",
        ]),
        (t.exports = e);
    },
            ...
            computed: {
              ContentViewStyle: function () {
                return "height:calc(100% - "
                  ...
                  .concat(
                    uni.upx2px(100),
                    "px);position:fixed;background-color:#ffffff;overflow-y: scroll;"
                  );
              },
            },
            watch: {
              querytext: function (e) {
                t.log("-------------" + e),
                  a.default.isNullOrEmpty(e)
                    ? (this.projectList = o)
                    : (this.projectList = o.filter(function (t) {
                        return t.project_name.indexOf(e) > -1;
                      }));
              },
            },
            onLoad: function () {
              this.GetAllProjectLsit();
            },
            methods: {
              GetAllProjectLsit: function () {
                var e = this;
                a.default.showloading("项目查询中..."),
                  a.default
                    .sendauthget(
                      a.default.DOMAIN_AUTH_SERVER_ADDR +
                        "webapi/" +
                        a.default.API_PATH.QueryUserHistoryProject,
                      {
                        phone:
                    ...
                    .then(function (n) {
                      uni.hideLoading(), t.log(n), (e.projectList = o = n);
                    })
                    .catch(function (t) {
                      uni.hideLoading(), a.default.showalert("查询项目失败", t);
                    })
                    .finally(function () {
                      e.queryFinished = !0;
                    });
              ...
              ChangeProject: function (e) {
                if (e != this.project.server_appid) {
                  var n = {
                      project_id: e,
                      phone:
                        this.userdata.phone || this.userdata.detailinfo.phone,
                      oauth_type: a.default.getplatformtype(),
                    },
                    i = this;
                  t.log(n),
                    a.default.showloading("项目切换中..."),
                    a.default
                      .sendauthget(
                        a.default.DOMAIN_AUTH_SERVER_ADDR +
                          "webapi/" +
                          a.default.API_PATH.UserChangeProject,
                        n
                      )
                      .then(function (e) {
                        var n = {};
                        uni.hideLoading(),
                          t.log("------willsetproject--------", n),
                          (i.project = n),
                          i.$store.commit("SetProjectData", n),
    ...
    dce2: function (t, e, n) {
      ...
      i.__esModule && (i = i.default),
        ...
        i.locals && (t.exports = i.locals);
      var a = n("4f06").default;
      a("6e84a34e", i, !0, { sourceMap: !1, shadowMode: !1 });
    },
    f61a: function (t, e, n) {
      "use strict";
      n.d(e, "b", function () {
                ...
                [
                  t._l(t.projectList, function (e) {
                    return n(
                      "v-uni-view",
                      {
                        staticClass: "project-item-container",
                        on: {
                          click: function (n) {
                            (arguments[0] = n = t.$handleEvent(n)),
                              t.ChangeProject(e.project_id);
                          },
                        },
                      },
                      [
                        n("v-uni-view", { staticClass: "name" }, [
                          t._v(t._s(e.project_name)),
                        ]),
                        n(
                          "v-uni-view",
                          { staticClass: "content" },
                          [
                            void 0 != e.balance
                              ? n("v-uni-view", { staticClass: "desc-item" }, [
                                  t._v(
                                    "余额:" +
                                      t._s(Number(e.balance).toFixed(2)) +
                                      "元"
                                  ),
                                ])
                              : t._e(),
                            void 0 != e.cash_coupon_count
                              ? n("v-uni-view", { staticClass: "desc-item" }, [
                                  t._v(
                                    "优惠券:" + t._s(e.cash_coupon_count) + "张"
                                  ),
                                ])
                              : t._e(),
                          ],
                        ...
                        t.project.server_appid == e.project_id
                          ? n(
                              "v-uni-view",
                  ...
                  0 == t.projectList.length && t.queryFinished
                    ? n(
                        "v-uni-view",
                        {
                          staticStyle: {
