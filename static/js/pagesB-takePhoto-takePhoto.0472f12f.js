  ...
  ["pagesB-takePhoto-takePhoto"],
  {
    ...
    "703e": function (t, e, i) {
      ...
      (function (t) {
        ...
        var a = n(i("f07e")),
          o = n(i("c964"));
        i("a9e3"), i("e9c4"), i("d3b7");
        var c = {
          props: {
            hasSwitch: { type: Boolean, default: !0 },
            hasAlbum: { type: Boolean, default: !0 },
            initScale: { type: Number, default: 1.277 },
            original: { type: Boolean, default: !0 },
          },
          data: function () {
            return { pusher: null, canvasW: 0, canvasH: 0, device: "front" };
          },
          onLoad: function () {
            t.log("开启相机" + JSON.stringify(this.$store.state.SystemInfo));
          },
          onUnload: function () {
            t.log("离开人脸采集"), uni.$off("FinishedTakePhoto");
          },
          computed: {
            scale: function () {
              return this.initScale > 1.77
                ? 1.77
                : this.initScale < 1.27
                ? 1.27
                : this.initScale;
            },
            livePusherStyle: function () {
              var e = {
                width: this.$store.state.SystemInfo.windowWidth,
                height:
                  this.$store.state.SystemInfo.windowHeight -
                  this.$store.state.SystemInfo.CustomBar,
              };
              return t.log(e), e;
            },
            closeContainerStyle: function () {
              return { top: this.$store.state.SystemInfo.CustomBar };
            },
            actionContainerStyle: function () {
              return { width: this.$store.state.SystemInfo.windowWidth };
            },
          },
          methods: {
            InitlivePusher: function () {
              (this.pusher = uni.createLivePusherContext("livePusher", this)),
                this.pusher.startPreview({
                  success: function (e) {
                    t.log("livePusher.startPreview:" + JSON.stringify(e));
                  },
                });
            },
            deviceQH: function () {
              this.hasSwitch &&
                (this.device = "back" == this.device ? "front" : "back");
            },
            closeView: function () {
              t.log("---------close-----------"), uni.navigateBack();
            },
            takePhoto: function () {
              var e = this;
              t.log("---------takePhoto-----------"),
                t.log("相机初始化完成"),
                t.log("------------takePhoto--------------");
              var i = uni.createCameraContext("camera");
              t.log("------------takePhoto--------ctx------" + i),
                i.takePhoto({
                  quality: "normal",
                  success: (function () {
                    var i = (0, o.default)(
                      (0, a.default)().mark(function i(n) {
                        var o;
                          ...
                          while (1)
                            switch ((i.prev = i.next)) {
                              case 0:
                                ...
                                return (i.next = 5), e.cutImg(o);
                              case 5:
                                o = i.sent;
                              case 6:
                                uni.navigateBack(),
                                  uni.$emit("FinishedTakePhoto", o);
                              case 8:
                              case "end":
                                return i.stop();
                            }
                ...
                uni.getImageInfo({
                  ...
                  success: function (t) {
                    var a = {
                        x: 0,
                        y:
                          t.height > e.scale * t.width
                            ? (t.height - e.scale * t.width) / 2
                            : 0,
                      },
                      o = t.width,
                      c =
                        t.height > e.scale * t.width
                          ? e.scale * t.width
                          : t.height,
                      s = uni.createCanvasContext("canvasid", e);
                    (e.canvasW = t.width),
                      (e.canvasH = t.height),
                      s.drawImage(t.path, 0, 0, e.canvasW, e.canvasH),
                      s.draw(!0, function () {
                        setTimeout(function () {
            ...
            chooseImage: function () {
              ...
              this.hasAlbum &&
                uni.chooseImage({
                  ...
                  sourceType: ["album"],
                  success: function (e) {
                    t.$emit("takePhoto", e.tempFilePaths[0]);
                  },
                });
            },
            error: function (e) {
    ...
    b03d: function (t, e, i) {
      ...
      a("6c7f87a7", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    d1cf: function (t, e, i) {
      "use strict";
      i.d(e, "b", function () {
      ...
      var n = function () {
          ...
          return n(
            ...
            [
              n("v-uni-cover-image", {
                staticClass: "allrl-container",
                style: t.livePusherStyle,
                attrs: { src: i("3cb9") },
              }),
              n(
                "v-uni-cover-view",
                    ...
                    on: {
                      click: function (e) {
                        (arguments[0] = e = t.$handleEvent(e)),
                          t.deviceQH.apply(void 0, arguments);
                      },
                    },
                  }),
                  n("v-uni-cover-image", {
                    staticClass: "coverImage take-photo-container",
                    staticStyle: { width: "120upx", height: "120upx" },
                    attrs: { src: i("4c441") },
                    on: {
                      click: function (e) {
                        (arguments[0] = e = t.$handleEvent(e)),
                          t.takePhoto.apply(void 0, arguments);
                      },
                    },
                  }),
                  n(
                    "v-uni-cover-view",
                    {
                      staticClass: "coverImage close-container",
                      on: {
                        click: function (e) {
                          (arguments[0] = e = t.$handleEvent(e)),
                            t.closeView.apply(void 0, arguments);
                        },
                      },
                    },
                    [t._v("取消")]
